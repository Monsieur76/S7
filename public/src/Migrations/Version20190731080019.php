 ...
 */
final class Version20190731080019 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_bile_mo (id INT AUTO_INCREMENT NOT NULL, name_product VARCHAR(255) NOT NULL, creat_date VARCHAR(255) NOT NULL, count INT NOT NULL, uid VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
